<?php declare(strict_types=1);
    ...
    if (API_REST_ACCESS_POST_A_TASK_LABEL == 'all') {
...
*/
    ...
    $a_task_label_Link = (bool) lecture_parametre_api("a_task_label_Link", '');
    $retour = $table_a_task_label->mf_ajouter($Code_task, $Code_label, $a_task_label_Link);
